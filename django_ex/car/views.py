...
class ListCreateCarView(ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return JsonResponse({'message': 'Create a new Car unsuccessful!'},
...
class UpdateDeleteCarView(RetrieveUpdateDestroyAPIView):
            ...
            return JsonResponse(
                {
                    ...
                    'new_car': serializer.data
                },
                status=status.HTTP_200_OK)

        return JsonResponse({'message': 'Update Car unsuccessful!'},
                            status=status.HTTP_400_BAD_REQUEST)
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return JsonResponse({'message': 'Delete Car successful!'},
                            status=status.HTTP_200_OK)
